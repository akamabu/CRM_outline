...
## CRM modules tiếp tục bổ sung

- Product catalog: tạo và tìm kiếm sản phẩm theo tenant/keyword.
- Quotation API: tạo, lọc và approve báo giá.
- Dashboard summary: tổng hợp nhanh số lượng lead, customer, deal, quotation, product, task và ticket theo tenant.
- Backend đã có unit test cho luồng lead create/assign/convert và duplicate detection.
